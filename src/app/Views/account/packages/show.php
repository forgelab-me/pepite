...
<?= $this->section('title') ?><?= esc($package['package_id']) ?> — My packages<?= $this->endSection() ?>
...
<p class="text-body-secondary">Feed: <?= esc($feed['name']) ?></p>
        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <?php foreach ($versions as $version): ?>
                <tr>
                    ...
                    <td class="text-end">
                        <?php $base = 'account/packages/' . $package['id'] . '/versions/' . $version['id']; ?>
